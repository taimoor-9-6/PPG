...
Original file is located at
    https://colab.research.google.com/drive/1l77w7YkV4YpEOP1g3BuarI5DqzI42dwH
"""
...
history=gen_corenet.fit(PPG_train,PPG_true_train, batch_size=25,epochs=100,verbose=1,validation_data=(PPG_test,PPG_true_test),callbacks=callbacks,use_multiprocessing=False)
...
with open('drive/My Drive/RAship/bidmc_corenet_loss.csv', 'w') as f:
  loss_1.to_csv(f)
...
with open('drive/My Drive/RAship/syn_corenet_preds_true_temp.csv', 'w') as f:
  bidmc.to_csv(f)
