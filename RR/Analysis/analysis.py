...
print("Mean absolute error and Standard Deviation for dataset bidmc on algorithm corenet is=", avg_mae_bidmc_corenet,"+-",avg_std_bidmc_corenet)
...
print("Mean absolute error and Standard Deviation for dataset bidmc on algorithm corenet+unet is=", avg_mae_bidmc_corenet_priors,"+-",avg_std_bidmc_corenet_priors)
...
print("Mean absolute error and Standard Deviation for dataset bidmc on algorithm resnet is=", avg_mae_bidmc_resnet,"+-",avg_std_bidmc_resnet)
...
print("Mean absolute error and Standard Deviation for dataset bidmc on algorithm resnet+unet is=", avg_mae_bidmc_resnet_priors,"+-",avg_std_bidmc_resnet_priors)
...
print("Mean absolute error and Standard Deviation for synthetic dataset on algorithm corenet is=", avg_mae_syn_corenet,"+-",avg_std_syn_corenet)
...
print("Mean absolute error and Standard Deviation for synthetic dataset on algorithm corenet+unet is=", avg_mae_syn_corenet_priors,"+-",avg_std_syn_corenet_priors)
...
print("Mean absolute error and Standard Deviation for synthetic dataset on algorithm resnet is=", avg_mae_syn_resnet,"+-",avg_std_syn_resnet)
...
print("Mean absolute error and Standard Deviation for synthetic dataset on algorithm resnet+unet is=", avg_mae_syn_resnet_priors,"+-",avg_std_syn_resnet_priors)
...
print("Mean squared error for dataset bidmc on algorithm corenet is=", avg_mse_bidmc_corenet)
...
print("Mean squared error for dataset bidmc on algorithm corenet+unet is=", avg_mse_bidmc_corenet_priors)

#Calculating mean squared error and standard deviation
avg_mse_bidmc_resnet=mean_squared_error(bidmc_resnet.true,bidmc_resnet.preds)
print("Mean squared error for dataset bidmc on algorithm resnet is=", avg_mse_bidmc_resnet)

#Calculating mean squared error and standard deviation
avg_mse_bidmc_resnet_priors=mean_squared_error(bidmc_resnet_priors.true,bidmc_resnet_priors.preds)
print("Mean squared error for dataset bidmc on algorithm resnet+unet is=", avg_mse_bidmc_resnet_priors)
...
print("Mean squared error for dataset syn on algorithm corenet is=", avg_mse_syn_corenet)

#Calculating mean squared error and standard deviation
avg_mse_syn_corenet_priors=mean_squared_error(syn_corenet_priors.true,syn_corenet_priors.preds)
print("Mean squared error for dataset syn on algorithm corenet+unet is=", avg_mse_syn_corenet_priors)

#Calculating mean squared error and standard deviation
avg_mse_syn_resnet=mean_squared_error(syn_resnet.true,syn_resnet.preds)
print("Mean squared error for dataset syn on algorithm resnet is=", avg_mse_syn_resnet)

#Calculating mean squared error and standard deviation
avg_mse_syn_resnet_priors=mean_squared_error(syn_resnet_priors.true,syn_resnet_priors.preds)
print("Mean squared error for dataset syn on algorithm resnet+unet is=", avg_mse_syn_resnet_priors)
...
# print("Root Mean squared error for dataset bidmc on algorithm corenet is=", avg_rmse_bidmc_corenet)

# #Calculating mean squared error and standard deviation
# avg_rmse_bidmc_corenet_priors=sqrt(mean_squared_error(bidmc_corenet_priors.true,bidmc_corenet_priors.preds))
# print("Root Mean squared error for dataset bidmc on algorithm corenet+unet is=", avg_rmse_bidmc_corenet_priors)

# #Calculating mean squared error and standard deviation
# avg_rmse_bidmc_resnet=sqrt(mean_squared_error(bidmc_resnet.true,bidmc_resnet.preds))
# print("Root Mean squared error for dataset bidmc on algorithm resnet is=", avg_rmse_bidmc_resnet)
...
print("R2 score for dataset bidmc on algorithm corenet is=", avg_r2_bidmc_corenet)

#Calculating mean squared error and standard deviation
avg_r2_bidmc_corenet_priors=r2_score(bidmc_corenet_priors.true,bidmc_corenet_priors.preds)
print("R2 score for dataset bidmc on algorithm corenet+unet is=", avg_r2_bidmc_corenet_priors)

#Calculating mean squared error and standard deviation
avg_r2_bidmc_resnet=r2_score(bidmc_resnet.true,bidmc_resnet.preds)
print("R2 score for dataset bidmc on algorithm resnet is=", avg_r2_bidmc_resnet)

#Calculating mean squared error and standard deviation
avg_r2_bidmc_resnet_priors=r2_score(bidmc_resnet_priors.true,bidmc_resnet_priors.preds)
print("R2 score for dataset bidmc on algorithm resnet+unet is=", avg_r2_bidmc_resnet_priors)
...
print("R2 score for dataset syn on algorithm corenet is=", avg_r2_syn_corenet)

#Calculating mean squared error and standard deviation
avg_r2_syn_corenet_priors=r2_score(syn_corenet_priors.true,syn_corenet_priors.preds)
print("R2 score for dataset syn on algorithm corenet+unet is=", avg_r2_syn_corenet_priors)

#Calculating mean squared error and standard deviation
avg_r2_syn_resnet=r2_score(syn_resnet.true,syn_resnet.preds)
print("R2 score for dataset syn on algorithm resnet is=", avg_r2_syn_resnet)

#Calculating mean squared error and standard deviation
avg_r2_syn_resnet_priors=r2_score(syn_resnet_priors.true,syn_resnet_priors.preds)
print("R2 score for dataset syn on algorithm resnet+unet is=", avg_r2_syn_resnet_priors)
