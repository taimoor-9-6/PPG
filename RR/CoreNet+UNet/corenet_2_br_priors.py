# -*- coding: utf-8 -*-
"""CoreNET_2_br_priors.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dwM1-cnRtlwZONSGj9n_YJ-iBBMKdDCZ
"""
...
# def conv_block(x, num_filters):
#     x = Conv1D(num_filters, 40, padding="casual")(x)
#     x = BatchNormalization()(x)
#     x = Activation("relu")(x)
#     x = Dropout(0.1)(x)
...
with open('drive/My Drive/RAship/syn_corenet_loss_prior.csv', 'w') as f:
  loss_1.to_csv(f)
...
with open('drive/My Drive/RAship/syn_corenet_priors_preds_true_temp.csv', 'w') as f:
  bidmc.to_csv(f)
